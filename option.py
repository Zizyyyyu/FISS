...
def args_parser():
    ...
    parser.add_argument("--cogamid_replay_max_per_class",type=int,default=512,help="deprecated per-class GMM replay limit")
    parser.add_argument("--cogamid_replay_total",type=int,default=512,help="total sampled GMM features shared by all old classes in one batch")
    parser.add_argument("--cogamid_old_replay",type=float,default=0.1,help="weight of supervised old-class GMM replay loss")
    parser.add_argument("--cogamid_extra_bg_max_ratio",type=float,default=1.0,help="maximum client-local extra background ratio")
